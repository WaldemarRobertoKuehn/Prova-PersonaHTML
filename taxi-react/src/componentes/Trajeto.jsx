  ...
  return (
    <section className="trajeto" aria-labelledby="tituloTrajeto">
      <div className="titulo-secao">
        <div><p className="etiqueta">TRAJETO SIMULADO</p><h2 id="tituloTrajeto">Centro → Rodoviaria</h2></div>
      ...
      <div className={corridaIniciada ? 'mapa em-viagem' : 'mapa'} aria-label="Representacao do trajeto entre o Centro e a Rodoviaria">
      ...
      <div className="dados-trajeto"><div><span>Distancia</span><strong>8 km</strong></div><div><span>Tempo</span><strong>20 min</strong></div></div>
      ...
      <div className="campos-valores" aria-labelledby="tituloValores">
        ...
        <div className="grade-campos">
          ...
          <label>Valor por km<span className="campo-dinheiro"><span>R$</span><input value={valorKm} onChange={(evento) => aoMudarValorKm(evento.target.value)} disabled={corridaIniciada} inputMode="decimal" autoComplete="off" placeholder="0,00" aria-label="Valor por quilometro em reais" /></span></label>

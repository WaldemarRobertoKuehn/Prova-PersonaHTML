function Adicionais({ adicionais, corridaIniciada, corridaCalculada, aviso, aoAdicionar }) {
  return (
    <section className="adicionais" aria-labelledby="tituloAdicionais">
      <div className="titulo-secao"><div><p className="etiqueta">VALORES COM O CARRO PARADO</p><h2 id="tituloAdicionais">Adicionar cobrança</h2></div></div>
      ...
      <div className="grade-botoes">
        ...
        {adicionais.map((adicional) => (
          ...
          <button className="botao botao-valor" type="button" key={adicional.id} disabled={corridaIniciada || !corridaCalculada} onClick={() => aoAdicionar(adicional.nome)}>
